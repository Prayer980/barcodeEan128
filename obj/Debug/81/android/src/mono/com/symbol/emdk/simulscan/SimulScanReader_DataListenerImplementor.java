...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Symbol.XamarinEMDK.SimulScan.SimulScanReader+IDataListenerImplementor, Symbol.XamarinEMDK", SimulScanReader_DataListenerImplementor.class, __md_methods);
	}


	public SimulScanReader_DataListenerImplementor ()
	{
		super ();
		if (getClass () == SimulScanReader_DataListenerImplementor.class)
			mono.android.TypeManager.Activate ("Symbol.XamarinEMDK.SimulScan.SimulScanReader+IDataListenerImplementor, Symbol.XamarinEMDK", "", this, new java.lang.Object[] {  });
	}
